...
def Potencias(i,Irms,Vrms,potrmsCGE):
    ...
    if(TimeEnergy.minute==19):
        if(acceshourenergy==0):
            ...
            if(TimeEnergy.hour==13 and TimeEnergy.minute==19):
                workbook=openpyxl.load_workbook(filename = dest_filename)
