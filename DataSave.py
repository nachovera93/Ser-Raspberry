...
def Maximo15min(Vrms, Irms, ActivePower, ReactivePower, AparentPower, FP_Reactive_lists, FP_Inductive_lists, FDVoltage, FDCurrent, DATVoltage, DATCurrent, OneHourEnergy, Energy, mongo_connect):
    max_Vrms = max(Vrms)
    min_Vrms = min(Vrms)
